public class Main {
  ...
  /*
    ...
    It would not handle nested objects or arrays, and it would not handle whitespace or formatting differences correctly. It also wouldn't handle string values that contain commas or colons.
  */
